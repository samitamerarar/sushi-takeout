...
var cartTotal = document.querySelector(".amount");
var qtyField;
...
function updateCartAdd(sushi) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/update-cart", sushi).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var sushi = JSON.parse(btn.dataset.sushi);
    updateCartAdd(sushi);
  });
});

function updateCartRemove(sushi) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/remove-from-cart", sushi).then(function (res) {
    cartCounter.innerText = res.data.totalQty;
...
__webpack_require__(/*! C:\Users\Sam\Documents\Personal Projects\realtime-sushi\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Sam\Documents\Personal Projects\realtime-sushi\resources\scss\app.scss */"./resources/scss/app.scss");
